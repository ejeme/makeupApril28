...
var app = express();
//.env is added so it can load on heroku
var PORT = process.env.PORT || 3000;
//Is required s we can use handlebars in the app
var exphbs = require("express-handlebars");
//Tell express we are using default layout and its going to be the main
